...
const cardVariants = cva('rounded-[var(--sv-radius)] text-sv-text', {
  variants: {
    ...
    interactive: {
      true: 'transition-all duration-fast ease-sv hover:-translate-y-0.5 hover:shadow-modal focus-visible:ring-2 focus-visible:ring-sv-accent focus-visible:ring-offset-2 focus-visible:ring-offset-sv-bg motion-reduce:transition-none motion-reduce:hover:translate-y-0',
      false: ''
    }
  },
  defaultVariants: {
